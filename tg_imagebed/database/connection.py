...
def _create_indexes(cursor) -> None:
    ...
    index_statements = [
        ...
        'CREATE INDEX IF NOT EXISTS idx_file_storage_upload_time ON file_storage(upload_time)',
        ...
        'CREATE INDEX IF NOT EXISTS idx_file_storage_auth_created ON file_storage(auth_token, created_at DESC)',
